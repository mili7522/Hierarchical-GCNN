...
saveName = 'Results/2018-11-13-DeepComparison-HousingSuitability-l={:d}-n={:d}.csv'.format(l,n)

###
data = pd.read_csv('Data/NewData/2018-11-13-NSW-SA1Input-HousingSuitability-Normalised.csv')

data = data[data.iloc[:,-1] >= -9]  # Exclude invalide values
