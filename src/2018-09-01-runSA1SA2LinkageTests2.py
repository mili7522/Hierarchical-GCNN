...
def runBatch(expParameters, l = 2, n = 128):
...
### Test 10
expParameters = {"reverseLinkagePosition": "Early", "linkagePosition": "Late", "linkageActFun": False, "linkageBatchNorm": False,
...
### Test 11
expParameters = {"reverseLinkagePosition": "Early", "linkagePosition": "Late", "linkageActFun": True, "linkageBatchNorm": False,
                 "linkageNeurons": None, "auxilaryEmbedding1": False, "auxilaryEmbedding2": False, "auxilaryGraph": True}
print(expParameters)
dfs.append( runBatch(expParameters = expParameters) )
...
expParameters = {"reverseLinkagePosition": "Late", "linkagePosition": "Late", "linkageActFun": False, "linkageBatchNorm": True,
                 "linkageNeurons": None, "auxilaryEmbedding1": False, "auxilaryEmbedding2": True, "auxilaryGraph": False}
print(expParameters)
dfs.append( runBatch(expParameters = expParameters) )
...
### Test 13
expParameters = {"reverseLinkagePosition": "Late", "linkagePosition": "Late", "linkageActFun": False, "linkageBatchNorm": True,
                 "linkageNeurons": None, "auxilaryEmbedding1": True, "auxilaryEmbedding2": False, "auxilaryGraph": False}
print(expParameters)
dfs.append( runBatch(expParameters = expParameters) )
...
### Combine and output
df = pd.concat(dfs)
df.to_csv("2018-09-01-TestResults2.csv")


### Test 14
expParameters = {"reverseLinkagePosition": "Late", "linkagePosition": "Late", "linkageActFun": False, "linkageBatchNorm": True,
                 "linkageNeurons": None, "auxilaryEmbedding1": True, "auxilaryEmbedding2": False, "auxilaryGraph": True}
print(expParameters)
dfs.append( runBatch(expParameters = expParameters) )
...
print(expParameters)
dfs.append( runBatch(expParameters = expParameters, n = 3) )
...
expParameters = {"reverseLinkagePosition": "None", "linkagePosition": "None", "linkageActFun": True, "linkageBatchNorm": True,
                 "linkageNeurons": None, "auxilaryEmbedding1": False, "auxilaryEmbedding2": False, "auxilaryGraph": False}
print(expParameters)
dfs.append( runBatch(expParameters = expParameters, l = 64) )
